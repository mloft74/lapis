...
## Lapis themes and forks

[ccos89](https://github.com/ccos89) made a few themes for Lapis based on the [Catpuccin palette](https://catppuccin.com/palette/). You can find them [over here](https://github.com/ccos89/lapis-catpuccin). This might alter the pitch color accent, so do keep it in mind. Alternatively, some people have forked and extended Lapis, e.g. [lapis-extended](https://github.com/kiwakiwaa/lapis-extended) and [lapis-modified](https://github.com/friedrich-de/lapis-modified). If you decide to use these forks and you run into issues, please **use their issue tracker first**.
